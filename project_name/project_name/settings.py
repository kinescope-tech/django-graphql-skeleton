...
Template: https://github.com/kinescope-tech/django-graphql-skeleton
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'gql123'),
        'HOST': os.environ.get('POSTGRES_HOST', 'db') if GQ_ENV in PROD_ENV_TAGS else 'localhost',
        'PORT': os.environ.get('POSTGRES_PORT', 5432),
        'TEST': {'NAME': os.environ.get('POSTGRES_TEST_DB', '{{project_name}}_test')},
    }
}
